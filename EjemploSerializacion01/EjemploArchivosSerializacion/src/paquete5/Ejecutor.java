...
public class Ejecutor {
    ...
    public static void main(String[] args) {
        ...
        Hospital h1 = new Hospital("Vicente Moscozo", 300, 58765.12, "104050");
        Hospital h2 = new Hospital("Santa Isabel", 250, 64523.12, "756384");
        Hospital h3 = new Hospital("Isidro Ayora", 100, 12000.82, "984654");
